...
class Factura(models.Model):
    ...
    obj_cliente = models.ForeignKey(Cliente, null=True, blank=True, on_delete=models.SET_NULL)
    ...
    obj_forma_pago = models.ForeignKey(FormaPago, null=True, blank=True, on_delete=models.SET_NULL)
...
class Producto(models.Model):
    ...
    obj_rubro = models.ForeignKey(Rubro, null=True, blank=True, on_delete=models.SET_NULL)
...
class Receta(models.Model):
    obj_ingrediente = models.ForeignKey(Ingrediente, null=True, blank=True, on_delete=models.SET_NULL)
    obj_producto = models.ForeignKey(Producto, null=True, blank=True, on_delete=models.SET_NULL)
    sys_active = models.BooleanField(default=True)
    sys_fechaCreacion = models.DateTimeField(auto_now_add=True)
    sys_fechaActualizacion = models.DateTimeField(auto_now = True)
